    ...
    <div class="col-md-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <a href="#" class="btn btn-box-tool" data-toggle="tooltip" title="Próximo"><i class="fa fa-chevron-left"></i></a>
            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border text-center">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Excluír">
                            <i class="fa fa-trash-o"></i>
                        </button>
                    </div>
                    <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="Arquivar">
